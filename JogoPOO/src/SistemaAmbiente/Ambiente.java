...
public abstract class Ambiente {
    ...
    public static void prologo() {//Printa o Prologo do jogo
    	System.out.println("Há muito tempo, a Aldeia Verdejante era conhecida por suas colheitas abundantes e pela vitalidade de suas florestas. O pequeno vilarejo, situado ao pé de antigas\ncolinas, vivia em harmonia com o misterioso Bosque Verdejante, um lugar sagrado onde os aldeões buscavam proteção e sustento.\n");
    	System.out.println("No entanto, nos últimos meses, algo mudou. As árvores começaram a secar, o solo se tornou infértil, e os animais, outrora abundantes, desapareceram. Os aldeões tentaram\nrezar para os antigos deuses do bosque, mas o silêncio foi a única resposta que receberam. Medo e desespero cresceram, e rumores de uma maldição começaram a se espalhar.\n");
